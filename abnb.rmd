...
zoning.key.kgp <- rbind(c("OS-N",NA,NA,NA,NA),
                        c("OS-G",NA,NA,NA,NA)
                          )
...
# Suburban Neighborhoods
                        c("Suburban Neighborhoods", "S-RS", "Single-Family Residential District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-RD", "Two-Family Residential District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-RM1", "Multi-Family Residential District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-RM2", "Multi-Family Residential District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-LRS1", "Lakeview Single-Family Residential District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-LRS2", "Lake Vista and Lake Shore Single-Family Residential District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-LRS3", "Lakewood and Country Club Gardens Single-Family Residential District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-LRD1", "Lake Vista Two-Family Residential District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-LRD2", "Lakewood/Parkview Two-Family Residential District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-LRM1", "Lake Area Low-Rise Multi-Family Residential District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-LRM2", "Lake Area High-Rise Multi-Family Residential District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-B1", "Suburban Business District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-B2", "Pedestrian-Oriented Corridor Business District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-LB1", "Lake Area Neighborhood Business District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-LB2", "Lake Area Neighborhood Business District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-LC", "Lake Area General Commercial District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-LP", "Lake Area Neighborhood Park District", "", "", "", "","","",""),
                        c("Suburban Neighborhoods", "S-LM", "Lake Area Marina District", "", "", "", "","","",""),
 #Commercial Center and Institutional Campus Districts

                        c("Commercial Center and Institutional Campus Districts", "C-1", "General Commercial District", "", "", "", "","","",""),
                        c("Commercial Center and Institutional Campus Districts", "C-2", "Auto-Oriented Commercial District", "", "", "", "","","",""),
                        c("Commercial Center and Institutional Campus Districts", "C-3", "Heavy Commercial District", "", "", "", "","","",""),
                        c("Commercial Center and Institutional Campus Districts", "MU-1", "Medium Intensity Mixed-Use District", "", "", "", "","","",""),
                        c("Commercial Center and Institutional Campus Districts", "MU-2", "High Intensity Mixed-Use District", "", "", "", "","","",""),
                        c("Commercial Center and Institutional Campus Districts", "EC", "Educational Campus District", "", "", "", "","","",""),
                        c("Commercial Center and Institutional Campus Districts", "MC", "Medical Campus District", "", "", "", "","","",""),
                        c("Commercial Center and Institutional Campus Districts", "MS", "Medical Service District", "", "", "", "","","",""),
                        c("Commercial Center and Institutional Campus Districts", "LS", "Life Science Mixed-Use District", "", "", "", "","","",""),
#Centers for Industry
                        c("Centers for Industry", "LI", "Light Industrial District", "", "", "", "","","",""),
                        c("Centers for Industry", "HI", "Heavy Industrial District", "", "", "", "","","",""),
                        c("Centers for Industry", "MI", "Maritime Industrial District", "", "", "", "","","",""),
                        c("Centers for Industry", "BIP", "Business-Industrial Park District", "", "", "", "","","",""),

#Central Business District

                        c("Central Business District", "CBD-1", "Core Central Business District", "", "", "", "","","",""),
                        c("Central Business District", "CBD-2", "Historic Commercial and Mixed-Use District", "", "", "", "","","",""),
                        c("Central Business District", "CBD-3", "Cultural Arts District", "", "", "", "","","",""),
                        c("Central Business District", "CBD-4", "Exposition District", "", "", "", "","","",""),
                        c("Central Business District", "CBD-5", "Urban Core Neighborhood Lower Intensity Mixed-Use District", "", "", "", "","","",""),
                        c("Central Business District", "CBD-6", "Urban Core Neighborhood Mixed-Use District", "", "", "", "","","",""),
                        c("Central Business District", "CBD-7", "Bio-Science District", "", "", "", "","","",""),
